...
export namespace Colors {
	 ...
	 */
	export async function interpolate(rgbOrHex: RGB3 | string): Promise<ThemeColor> {
	 ...
	 */
	export async function hashColor(hashString: string): Promise<ThemeColor> {
	 ...
	 */
	export async function HEX2RGB(hex: string): Promise<RGB3> {
		hex = hex.replace("#", "");
